...
- `CF_API_TOKEN`：Cloudflare API Token，用于创建/删除 `_acme-challenge` TXT 记录（Zone:DNS Edit）。
...
`https://deploy.workers.cloudflare.com/?url=https://github.com/yoogg/acme-cert-worker`
